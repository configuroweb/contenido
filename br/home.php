            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
                        <h2 class="text-center font-weight-bolder m-0">Contendo</h2>
                        <center>
                        ...
                        <div class="my-2 list-group">
                            ...
                            ?>
                                <div class="list-group-item">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <small class="text-muted">Escrito por: <span class="text-primary"><?= $row['writer'] ?></span></small>
                                        </div>
                                    ...
                                    <div class="text-right">
                                        <a href="./?p=blogs/view_blog&id=<?= $row['id'] ?>" class="btn btn-default border btn-flat btn-sm">Mais informação</a>
                                    </div>
                                </div>
                            <?php endwhile; ?>
                        </div>
