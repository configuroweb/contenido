...
<div class="card card-outline rounded-0 card-primary">
	<div class="card-header">
		...
		<div class="card-tools">
			<a class="btn btn-sm btn-flat btn-warning" id="create_new"><i class="fa fa-plus"></i> Adicionar novo usuário</a>
		</div>
	</div>
	<div class="card-body">
...
<script>
	$(document).ready(function() {
		$('#create_new').click(function() {
			uni_modal("Adicionar novo usuário", "user/manage_user.php")
		})
		$('.edit_data').click(function() {
			uni_modal("Atualizar conta de usuário", "user/manage_user.php?id=" + $(this).attr('data-id'))
		})
		$('.delete_data').click(function() {
			_conf("Tem certeza de excluir este usuário permanentemente?", "delete_user", [$(this).attr('data-id')])
		})
		$('.table').dataTable({
			columnDefs: [{
				orderable: false,
