<div class="contact py-3">
	<div class="card card-outline card-primary shadow rounded-0">
		<div class="card-header">
			<h5 class="card-title"><b>Informações de Contato</b></h5>
		</div>
		<div class="card-body">
					...
					<div class="row justify-content-center">
						<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
							<div class="form-group">
								<label for="school_address" class="control-label">Endereço</label>
							...
							<div class="form-group">
								<label for="school_tel_no" class="control-label">Número de telefone</label>
							...
							<div class="form-group">
								<label for="school_mobile" class="control-label">Número de telemóvel</label>
							...
							<div class="form-group">
								<label for="map_coords" class="control-label">Coordenada do mapa</label>
		...
		<div class="card-footer py-1 text-right">
			<button class="btn btn-primary btn-flat" type="submit" form="contact-form"><i class="fa fa-save"></i> Salvar informações de contato</button>
		</div>
	</div>
</div>
<script>
