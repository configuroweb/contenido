...
<div class="content py-3">
    <div class="card card-outline card-primary rounded-0 shadow">
        <div class="card-header">
            <h5 class="card-title"><b><?= isset($id) ? "Atualizar artigo" : "Criar Publicação" ?></b></h5>
        </div>
        <div class="card-body">
            <form action="" id="article-form">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group">
                            <label for="short_description" class="control-label">Resumo</label>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group">
                            <label for="content" class="label-control-label">Contente</label>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="custom-control custom-checkbox">
                                ...
                                <label for="status" class="custom-control-label">Criar Conteúdo</label>
                            </div>
                        </div>
                    </div>
                <?php endif; ?>
        ...
        <div class="card-footer text-center"><button class="btn btn-primary rounded-pill btn-sm w-25" type="submit" form="article-form"><i class="fa fa-save"></i> Guarda</button></div>
    </div>
</div>
<script>
    $(function() {
