    ...
    <div class="card card-outline card-primary rounded-0 shadow">
        <div class="card-header">
            ...
            <div class="card-tools">
                <a href="./?page=articles/manage_article&id=<?= isset($id) ? $id : "" ?>" class="btn btn-primary bg-gradient-warning btn-sm btn-flat"><i class="fa fa-edit"></i> Edit Article</a>
        ...
        <div class="card-body">
            <dl>
                ...
                <dd class="pl-4">
                    ...
                    switch ($status) {
                        case 1:
                            echo "<span class='badge badge-primary px-3 rounded-pill bg-gradient-warning'>Published</span>";
                            break;
                        case 0:
